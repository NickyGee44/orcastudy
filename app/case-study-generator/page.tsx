        ...
        <div className="sticky bottom-0 p-4 bg-gradient-to-t from-orca-dark/98 via-orca-dark/95 to-transparent backdrop-blur-md border-t border-orca-purple/20 shadow-2xl">
          <div className="max-w-4xl mx-auto w-full flex justify-center">
            <button
              ...
              className="w-full max-w-sm px-6 py-3.5 bg-gradient-to-r from-orca-purple via-orca-blue to-orca-purple hover:from-orca-purple-dark hover:via-orca-blue-dark hover:to-orca-purple-dark text-orca-light font-bold rounded-xl transition-all shadow-lg hover:shadow-2xl hover:scale-[1.02] flex items-center justify-center space-x-3 text-sm"
            >
