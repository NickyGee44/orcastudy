    ...
    <div className="space-y-2">
      ...
      <div className="flex space-x-2">
        <button
          ...
          className="flex-1 px-4 py-2 bg-orca-accent hover:bg-orca-accent-dark disabled:bg-orca-grey-2 disabled:text-orca-grey-3 text-orca-dark font-medium rounded-md transition-colors flex items-center justify-center space-x-2 text-sm"
        >
        ...
        <button
          onClick={exportToPNG}
          disabled={isExporting}
          className="flex-1 px-4 py-2 bg-orca-grey-1 hover:bg-orca-grey-2 disabled:bg-orca-grey-2 disabled:text-orca-grey-3 text-orca-light font-medium rounded-md transition-colors flex items-center justify-center space-x-2 border border-orca-grey-2 text-sm"
        >
