      ...
      {showResetConfirm && (
        <div className="p-3 bg-yellow-900/20 border border-yellow-700/50 rounded-lg animate-in">
          <div className="flex items-start space-x-2">
            <svg className="w-4 h-4 max-w-[16px] max-h-[16px] text-yellow-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style={{ width: '16px', height: '16px', flexShrink: 0 }}>
