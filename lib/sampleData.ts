...
export function generateSampleData(): CaseStudyConfig {
  ...
  return {
    ...
    title: 'Global Manufacturing Corp Achieves 18% Freight Cost Reduction with Orca Intelligence',
    ...
    challenge: 'The company was struggling with invoice discrepancies, overcharges, and lack of visibility into freight spending patterns. Manual audit processes were time-consuming and error-prone, resulting in millions of dollars in unclaimed savings. The finance team spent hundreds of hours each month reconciling invoices and disputing charges.',
    solution: 'Orca Intelligence implemented a comprehensive freight audit and analytics solution, integrating with the company\'s TMS and carrier systems. Our automated audit engine processes every invoice in real-time, flagging discrepancies and overcharges. Advanced analytics provide deep insights into spending patterns, carrier performance, and cost optimization opportunities.',
    resultsSummary: 'Within the first year, Global Manufacturing Corp achieved significant cost savings and operational improvements. The automated audit process eliminated manual work, improved accuracy, and recovered millions in overcharges.',
    outcomes: [
    ...
    testimonial: {
      quote: 'Orca Intelligence transformed our freight audit process. We\'ve recovered millions in overcharges and gained insights we never had before. The ROI was immediate, and the team loves how easy it is to use.',
      name: 'Sarah Johnson',
